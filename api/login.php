        ...
        <div class="auth-card">
            ...
            <div class="logo-area">
                ...
                <div class="logo-text">Ali Hosting</div>
                            ...
                            <h3 style="text-align:center; margin-top:0;">استعادة كلمة المرور</h3>
                <p class="desc-text">أدخل بريدك الإلكتروني المسجل لدينا وسنرسل لك رمزاً لإعادة التعيين.</p>
                <form method="POST">
                    <input type="hidden" name="csrf_token" value="1ab809b9d211ffcab38055667f217bd342e6fb409323009e14ab757c2608ee30">
                    <div class="inp-group">
                        <input type="email" name="f_email" class="inp" placeholder="البريد الإلكتروني" required>
                    ...
                    <button type="submit" name="forgot_request" class="btn btn-orange">إرسال الرمز</button>
                    <a href="login.php" class="btn btn-cancel">رجوع للوراء</a>
                </form>
